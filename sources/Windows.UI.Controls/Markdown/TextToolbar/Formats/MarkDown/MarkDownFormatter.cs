...
namespace CommunityToolkit.Windows.UI.Controls.TextToolbarFormats.MarkDown
{
    /// <summary>
    ...
    public class MarkDownFormatter : Formatter
    {
        ...
        public void StyleHeader(ToolbarButton button)
        {
            ...
            for (int i = 1; i <= 5; i++)
            {
                ...
                var item = new ListBoxItem
                {
                    ...
                    {
                        Text = val + "WCT_TextToolbar_HeaderLabel".GetLocalized("CommunityToolkit.Windows.UI.Controls.Core/Resources"),
        ...
        public override ButtonMap DefaultButtons
        {
            get
            {
                ...
                {
                    Name = QuoteElement,
                    ToolTip = "WCT_TextToolbar_QuoteLabel".GetLocalized("CommunityToolkit.Windows.UI.Controls.Core/Resources"),
                ...
                return new ButtonMap
                {
                    ...
                    new ToolbarButton
                    {
                        ...
                        ToolTip = "WCT_TextToolbar_HeaderLabel".GetLocalized("CommunityToolkit.Windows.UI.Controls.Core/Resources"),
                        Activation = StyleHeader
                    },
                    new ToolbarButton
                    {
                        Name = CodeElement,
                        ToolTip = "WCT_TextToolbar_CodeLabel".GetLocalized("CommunityToolkit.Windows.UI.Controls.Core/Resources"),
