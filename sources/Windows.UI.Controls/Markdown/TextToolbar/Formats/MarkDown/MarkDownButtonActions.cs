...
namespace CommunityToolkit.Windows.UI.Controls.TextToolbarFormats.MarkDown
{
    ...
    public class MarkDownButtonActions : ButtonActions
    {
        ...
        public override void FormatLink(ToolbarButton button, string label, string formattedText, string link)
        {
            ...
            string urlLabel = "WCT_TextToolbar_UrlLabel".GetLocalized("CommunityToolkit.Windows.UI.Controls.Core/Resources");
            string labelLabel = "WCT_TextToolbar_LabelLabel".GetLocalized("CommunityToolkit.Windows.UI.Controls.Core/Resources");
