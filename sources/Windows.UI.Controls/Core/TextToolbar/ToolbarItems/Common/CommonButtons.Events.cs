...
namespace Community.Windows.UI.Controls.TextToolbarButtons.Common
{
    /// <summary>
    ...
    public partial class CommonButtons
    {
        ...
        public async void OpenLinkCreator(ToolbarButton button)
        {
            ...
            {
                PlaceholderText = "WCT_TextToolbar_LabelLabel".GetLocalized("Community.Windows.UI.Controls.Core/Resources"),
                Margin = new Thickness(0, 0, 0, 5),
                AcceptsReturn = false
            };
            var linkBox = new TextBox
            {
                PlaceholderText = "WCT_TextToolbar_UrlLabel".GetLocalized("Community.Windows.UI.Controls.Core/Resources")
            };
            ...
            if (Model.UseURIChecker)
            {
                ...
                {
                    Content = "WCT_TextToolbar_RelativeLabel".GetLocalized("Community.Windows.UI.Controls.Core/Resources")
                };
            ...
            {
                Title = "WCT_TextToolbar_CreateLinkLabel".GetLocalized("Community.Windows.UI.Controls.Core/Resources"),
                Content = contentPanel,
                PrimaryButtonText = "WCT_TextToolbar_OkLabel".GetLocalized("Community.Windows.UI.Controls.Core/Resources"),
                SecondaryButtonText = "WCT_TextToolbar_CancelLabel".GetLocalized("Community.Windows.UI.Controls.Core/Resources")
            };
            ...
            if (result == ContentDialogResult.Primary)
            {
                ...
                string linkInvalidLabel = "WCT_TextToolbar_LinkInvalidLabel".GetLocalized("Community.Windows.UI.Controls.Core/Resources");
                string okLabel = "WCT_TextToolbar_OkLabel".GetLocalized("Community.Windows.UI.Controls.Core/Resources");
                string warningLabel = "WCT_TextToolbar_WarningLabel".GetLocalized("Community.Windows.UI.Controls.Core/Resources");
