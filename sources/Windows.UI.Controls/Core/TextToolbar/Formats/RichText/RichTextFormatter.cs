...
namespace Community.Windows.UI.Controls.TextToolbarFormats.RichText
{
    /// <summary>
    ...
    public class RichTextFormatter : Formatter
    {
        ...
        public override ButtonMap DefaultButtons
        {
            get
            {
                ...
                {
                    ToolTip = "WCT_TextToolbar_UnderlineLabel".GetLocalized("Community.Windows.UI.Controls.Core/Resources"),
