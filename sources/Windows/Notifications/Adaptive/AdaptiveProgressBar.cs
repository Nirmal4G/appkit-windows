...
using BindableProgressBarValue = CommunityToolkit.Windows.Notifications.AdaptiveProgressBarValue;
using BindableString = System.String;
#else
using BindableProgressBarValue = CommunityToolkit.Windows.Notifications.BindableProgressBarValue;
using BindableString = CommunityToolkit.Windows.Notifications.BindableString;
#endif
