...
namespace UnitTests.Helpers
{
    ...
    public class Test_ApplicationDataStorageHelper
    {
        ...
        /// <summary>
        /// If we try and deserialize a complex type with the <see cref="Community.Common.Helpers.SystemSerializer"/>, we do a check ourselves and will throw our own exception.
        /// </summary>
        [TestCategory("Helpers")]
        [TestMethod]
        ...
        /// <summary>
        /// The <see cref="Community.Common.Helpers.SystemSerializer"/> doesn't support complex types, since it just passes through directly.
